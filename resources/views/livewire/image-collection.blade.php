...
<div class="flex justify-center flex-grow">
    <div class="flex flex-grow-0 overflow-auto">
        <div class="flex flex-row flex-wrap flex-shrink-0 flex-grow-0 gap-2 p-1.5 mx-4 my-2 bg-gray-800 border rounded" style="width: 1330px;">
