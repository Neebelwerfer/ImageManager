    ...
    <x-grid class="w-7/12">
        <x-slot name="header">
            <div class="flex flex-row justify-between gap-2 ml-2">
                ...
                <x-button class="self-end px-4 mr-4 h-fit" wire:click="$dispatch('openModal', {component: 'modal.image.create-relation-classification', arguments: {'type': 'album'} })">Create Album</x-button>
            </div>
