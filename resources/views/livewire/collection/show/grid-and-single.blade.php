    ...
    <div class="relative flex flex-col h-full">
        ...
        @if (!$gridView && isset($singeleImage))
            <div class="h-full">
                ...
                <div class="flex flex-col justify-center w-full h-full mt-2 border-y"  x-on:keyup.left.window="$wire.previousImage()" x-on:keyup.right.window="$wire.nextImage()">
                    <div class="flex flex-row justify-center h-full">
                        <div class="flex justify-center ">
                            <livewire:image classes="flex justify-center w-4/6 h-full" :image="$singeleImage"/>
                        </div>
                    </div>
                </div>
            </div>
